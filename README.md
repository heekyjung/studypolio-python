...
1. [파이썬 문법 기초](01_파이썬_문법_기초)
 - [변수와 기본 데이터타입](01_파이썬_문법_기초/01_변수와_기본_데이터타입.ipynb)
 - [리스트](01_파이썬_문법_기초/02_리스트.ipynb)
 - [파이썬 프로그래밍의 기본 구조](01_파이썬_문법_기초/03_파이썬_프로그래밍의_기본_구조.ipynb)
 - [함수](01_파이썬_문법_기초/04_함수.ipynb)
 
2. [문자열 가지고 놀기](02_문자열_가지고_놀기.ipynb)
3. [함수 가지고 놀기](03_함수_가지고_놀기.ipynb)
4. [파이썬 문법 심화](04_파이썬_문법_심화)
 - [리스트 상세](04_파이썬_문법_심화/01_리스트_상세.ipynb)
 - [컬렉션](04_파이썬_문법_심화/02_컬렉션.ipynb)
